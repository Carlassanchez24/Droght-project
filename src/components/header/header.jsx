...
import logo from '../../assets/logo-cdm-dark.svg';
...
const Header = () => {
    ...
    return (
        <header>
            <nav className="bg-light border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between gap-4 items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center justify-end lg:order-2 space-x-2">
                        <a href="#" className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm lg:text-base px-6 py-3 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log in</a>
                        <a href="#" className="text-white bg-blue hover:bg-blue-600 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm lg:text-base px-6 py-3 mr-2 dark:bg-blue dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-primary-800 uppercase">Sign In</a>
                    ...
                    <div className={`justify-between items-center w-full lg:flex lg:w-auto lg:order-1 ${isMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-12 lg:mt-0">
                            <li>
                                <a href="/page" className="block py-2 pr-4 pl-3 text-bodyText border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 uppercase lg:text-[1rem]">Interactive Map</a>
                            </li>
                            <li>
                                <a href="/page/2" className="block py-2 pr-4 pl-3 text-bodyText border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 uppercase lg:text-[1rem]">Detailed Data</a>
                            </li>
                            <li>
                                <a href="/page/about" className="block py-2 pr-4 pl-3 text-bodyText border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 uppercase lg:text-[1rem]">About</a>
                            </li>
                        </ul>
                    </div>
                </div>
