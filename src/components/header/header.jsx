            ...
            <nav className="bg-light border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between gap-4 items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center justify-end lg:order-2 space-x-2">
                        <a href="/page/login" className="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm lg:text-base px-6 py-3 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">Log in</a>
                        <a href="/page/login" className="text-white bg-blue hover:bg-blue-600 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm lg:text-base px-6 py-3 mr-2 dark:bg-blue dark:hover:bg-blue-600 focus:outline-none dark:focus:ring-primary-800 uppercase">Sign In</a>
